...
/***/ function(module, exports, __webpack_require__) {
	...
	var _presence = __webpack_require__(7);
	
	var _presence2 = _interopRequireDefault(_presence);
	
	var _regexp = __webpack_require__(8);
...
/***/ function(module, exports) {
	...
	var isitAndroid = exports.isitAndroid = function isitAndroid() {
	  var userAgent = arguments.length <= 0 || arguments[0] === undefined ? USER_AGENT : arguments[0];
	...
	var isitChrome = exports.isitChrome = function isitChrome() {
	  var userAgent = arguments.length <= 0 || arguments[0] === undefined ? USER_AGENT : arguments[0];
	  var vendor = arguments.length <= 1 || arguments[1] === undefined ? VENDOR : arguments[1];
	...
	var isitIe = exports.isitIe = function isitIe(version) {
	  var userAgent = arguments.length <= 1 || arguments[1] === undefined ? USER_AGENT : arguments[1];
	...
	var isitOpera = exports.isitOpera = function isitOpera() {
	  ...
	  return OPERA_LEGACY_REGEXP.test(userAgent) || // Opera 12 and older versions
	  OPERA_MODERN_REGEXP.test(userAgent); // Opera 15+
	};
	...
	var isitTablet = exports.isitTablet = function isitTablet() {
	  var userAgent = arguments.length <= 0 || arguments[0] === undefined ? USER_AGENT : arguments[0];
	  var appVersion = arguments.length <= 1 || arguments[1] === undefined ? APP_VERSION : arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.isitWhitespace = exports.isitTruthy = exports.isitSpace = exports.isitFalsy = exports.isitExisty = exports.isitEmpty = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isitDay = exports.isitDay = function isitDay(object) {
	    var dayString = arguments.length <= 1 || arguments[1] === undefined ? DAY_STRINGS[new Date().getDay()] : arguments[1];
	...
	var isitMonth = exports.isitMonth = function isitMonth(object) {
	    var monthString = arguments.length <= 1 || arguments[1] === undefined ? MONTH_STRINGS[new Date().getMonth()] : arguments[1];
	...
	var isitToday = exports.isitToday = function isitToday(object) {
	    var today = arguments.length <= 1 || arguments[1] === undefined ? new Date() : arguments[1];
	...
	var isitTomorrow = exports.isitTomorrow = function isitTomorrow(object) {
	    var tomorrow = arguments.length <= 1 || arguments[1] === undefined ? new Date(new Date().setDate(new Date().getDate() + 1)) : arguments[1];
	...
	var isitYear = exports.isitYear = function isitYear(object) {
	    var yearNumber = arguments.length <= 1 || arguments[1] === undefined ? new Date().getFullYear() : arguments[1];
	...
	var isitYesterday = exports.isitYesterday = function isitYesterday(object) {
	    var yesterday = arguments.length <= 1 || arguments[1] === undefined ? new Date(new Date().setDate(new Date().getDate() - 1)) : arguments[1];
